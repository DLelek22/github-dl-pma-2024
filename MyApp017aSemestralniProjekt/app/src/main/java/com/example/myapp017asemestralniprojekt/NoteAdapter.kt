...
import com.example.myapp017asemestralniprojekt.databinding.ItemNoteBinding
...
class NoteAdapter(
    ...
    private val onShowClick: (Note) -> Unit,    // Funkce pro zobrazení poznámky
    ...
    inner class NoteViewHolder(private val binding: ItemNoteBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(note: Note) {
            ...
            binding.noteRecipePreview.text = note.recipe
            ...
            binding.iconDelete.setOnClickListener {
                AlertDialog.Builder(itemView.context)
                    .setTitle("Smazat recept")
                    .setMessage("Opravdu chcete tento recept smazat?")
            ...
            binding.iconShow.setOnClickListener {
                onShowClick(note)  // Vyvolání funkce pro zobrazení poznámky
            }
